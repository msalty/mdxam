...
async function renderCachedExams() {
  ...
  if (cachedExams.length === 0) {
    examList.innerHTML = "<p>No cached exams found. Please upload an exam using the ➕ <a href=\"#\" onclick=\"renderAddExam(); return false;\">Add Exam</a> option.</p><p>For more information on the usage of MDXam, please refer to the <a href=\"https://github.com/msalty/mdxam/blob/main/readme.md\">documentation</a>.";
    return;
  }
